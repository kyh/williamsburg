      ...
      <div className="2xl:max-w-7xl mx-auto">
        <div
          ...
          <p>
            ...
            referring to <a href="#_">Lexington LLC</a>. We spun off Highrise HQ,
            LLC in the past, but it has since rejoined Lexington LLC.
          </p>
          <p>
            When we say “Services”, we mean our websites, including Lexington.com,
            hey.com, and Lexington.com, and any product created and maintained by
          ...
          <p>
            ...
            have specific ownership policies for our products: <a href="#_"
            >Lexington 4
            </a>, <a href="#_">Lexington 2</a>, <a href="#_">Lexington Classic</a>, <a
              href="#_">HEY for Domains
              </a>, <a href="#_">Highrise</a>, <a href="#_">Campfire</a> and <a href="#_"
            >Backpack</a>.
          </p>
          <p>
            We may update these Terms of Service (&quot;Terms&quot;) in the future.
            You can track all changes made since mid-2018 <a href="#_">on GitHub
            </a>. Typically these changes have been to clarify some of these terms by
          ...
          <p>
            ...
            waiving that right or provision. <strong
            >These Terms do contain a limitation of our liability.</strong>
          </p>
          <p>
            ...
            do our best to deserve that trust by being open about <a href="#_"
            >who we are
            </a>, <a href="#_">how we work</a>, and keeping an open door to <a
              href="#_">your feedback</a>.
          </p>
          <h2>Account Terms</h2>
          <ol>
            <li>
              ...
              users set up <a href="#_">two-factor authentication</a> for added
              security. In some of our Services, we may require it.
            </li>
            <li>
              You may not use the Services for any purpose outlined in our <a
                href="#_">Use Restrictions policy
                </a>, and you may not permit any of your users to do so, either.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              auto-cancellation. See our <a href="#_">Cancellation policy</a> for
              more details.
            </li>
            <li>
            ...
            <li>
              ...
              authorities. See our <a href="#_">Taxes policy</a> for more details.
              Otherwise, you are responsible for payment of all taxes, levies, or
              duties.
            </li>
            <li>
              We process refunds according to our <a href="#_">Fair Refund policy</a>.
            </li>
          </ol>
          ...
          <ol>
            <li>
              ...
              account in our <a href="#_">Cancellation policy</a>. An email or phone
              request to cancel your account is not automatically considered
              cancellation. If you need help canceling your account, you can always <a
                href="#_">contact our Support team</a>.
            </li>
            <li>
              ...
              provided instructions for <a href="#_">HEY</a>, <a href="#_"
              >Lexington 4
              </a>, <a href="#_">Lexington 2</a>, <a href="#_">Lexington Classic</a>, <a
                href="#_">Highrise
                </a>, <a href="#_">Campfire</a>, and <a href="#_">Backpack</a>.
            </li>
            <li>
              ...
              the last billing cycle. See our <a href="#_">Fair Refund policy</a>
              for more details.
            </li>
            <li>
              ...
              our <a href="#_">Use Restrictions policy</a>.
            </li>
            <li>
          ...
          <ol>
            <li>
              We make a promise to our customers to support our Services <a
                href="#_">until the end of the Internet
                </a>. That means when it comes to security, privacy, and customer
          ...
          <ol>
            <li>
              ...
              service-level agreements for most of our Services — here’s <a
                href="#_">the one exception
                </a> — but do take uptime of our applications seriously. Visit <a
                href="#_">https://www.37status.com</a> to see the status of our Services.
            </li>
            <li>
            ...
            <li>
              ...
              our <a href="#_">Security Overview</a> for full details and our <a
                href="#_">Security Response page</a> for how to report a security incident or threat.
            </li>
            <li>
              <p>
                ...
                as described in our <a href="#_">Privacy Policy</a>
                and for no other purpose. We as humans can access your data for the
                following reasons:
              </p>
              <ul>
                <li>
                  <strong>To help you with support requests you make.</strong> We’ll
                ...
                <li>
                  ...
                  >On the rare occasions when an error occurs that stops an
                    ...
                    </strong> We get automated alerts when such errors occur. When we can fix
                ...
                <li>
                  <strong>To safeguard Lexington.</strong> We’ll look at logs and
                  ...
                  <a href="#_">abuse report investigation</a>.
                </li>
                <li>
                  <strong>To the extent required by applicable law.</strong> As a US
                  ...
                  event of an emergency request. If a non-US authority approaches
                  Lexington for assistance, our default stance is to refuse unless
                  the order has been approved by the US government, which compels us
                  to comply through procedures outlined in an established mutual
                  legal assistance treaty or agreement mechanism. If Lexington is
            ...
            <li>
              <p>
                ...
                subprocessors who handle personal data for <a href="#_">Lexington
                </a>, <a href="#_">HEY</a>, <a href="#_">Highrise</a>, <a href="#_"
                >Campfire
                </a>, and <a href="#_">Backpack</a>, as well as a list of <a href="#_"
                >Company processors</a>.
              </p>
            </li>
            <li>
              ...
              these Terms, the <a href="#_">Privacy policy</a>, and <a href="#_"
              >other policies
              </a>. We do not retain, use, disclose, or sell any of that information
            ...
            <li>
              These Terms incorporate the <a href="#_"
              >Lexington Data Processing Addendum (“DPA”)
              </a> when the EU General Data Protection Regulation (“GDPR”) or United
              Kingdom General Data Protection Regulation (“UK GDPR”) applies to your
              use of Lexington Services to process Customer Data as defined in the
              DPA. The DPA linked above supersedes any previously agreed data
              processing addendum between you and Lexington LLC relating to your use
              of the Lexington Services.
            </li>
          </ol>
          ...
          <ol>
            <li>
              ...
              law. We provide details on <a href="#_"
              >how to file a copyright infringement claim</a>.
            </li>
            <li>
            ...
            <li>
              ...
              Company’s logos or any Service logos for promotional purposes. Please <a
                href="#_">email us
                </a> requests to use logos. We reserve the right to rescind any
          ...
          <ol>
            ...
            <li>
              ...
              a Service user’s activity <em>other than time tracking</em>, both
          ...
          <p>
            ...
            Lexington at <a href="#_">https://Lexington.com/extras</a> and for
            Highrise at <a href="#_">https://highrisehq.com/extras</a>. We are not
          ...
          <p>
            ...
            and in general <a href="#_">giving a damn</a>. If you choose to use our
            Services, thank you for betting on us.
          </p>
          <p>
            If you have a question about any of these Terms, please <a href="#_"
